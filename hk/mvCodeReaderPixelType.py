...
MV_CODEREADER_GVSP_PIX_RGB = 0x02000000  # deprecated in version 1.1
...
def MV_CODEREADER_PIXEL_BIT_COUNT(n): return (n) << 16
...
MV_CODEREADER_GVSP_PIX_COUNT = 0x46  # next Pixel ID available


class MvCodeReaderGvspPixelType:
    ...
    # 0x024000C2, /* 3D coordinate A-C 32-bit floating point */
    PixelType_CodeReader_Gvsp_Coord3D_AC32f = MV_CODEREADER_GVSP_PIX_COLOR | MV_CODEREADER_PIXEL_BIT_COUNT(40) | 0x00C2
